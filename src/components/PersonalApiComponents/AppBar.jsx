...
const Container = styled.div`
    border-bottom: 0.5px solid ${props => props.theme.body};
`
...
const AppBar = ({ title, icon, handleClose }) => {
    const { theme } = useContext(ThemeContext);
    
    return (
      <Container className='w-full h-12 flex justify-between sticky top-0 left-0'>
